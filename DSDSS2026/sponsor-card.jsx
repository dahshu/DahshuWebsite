...
// sponsor name beneath. Reuses the invited-speaker vertical-card look
// (speaker / speaker-vertical). The sponsorship level is shown as a banner
// above a group of cards, not on the card itself. Styling lives in the
// .speaker-* rules plus .sponsor-logo in _assets/dsdss2026.css.
//
//   <SponsorCard image="acme.png" name="Acme" />
//
...
export function SponsorCard({ image, name }) {
